...
module.exports = function(eleventyConfig) {
  ...
  eleventyConfig.addFilter("date", (dateObj) => {
    if (!(dateObj instanceof Date)) {const markdownIt = require("markdown-it");
...
module.exports = function(eleventyConfig) {
  ...
  // ⭐️⭐️⭐️ Filter: Unique tag list (used for the tags page) WITH PRESET TAGS ⭐️⭐️⭐️
